				...
				<div class="flex items-center gap-10">
					<div>
						<form id="search-bar" class="flex"> 
							<input placeholder="Search Animes" class="px-6 py-2 outline-none text-black rounded-full" type="text" name="" id="" />
							<button>
					...
					<nuxt-link class="flex" to="/" id="favorites-button">
						...
						<span class="ml-2 text-red-400">My Watchlist</span>
					</nuxt-link>
				</div>
			</div>
		</div>
